<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="RoomBooking.WebForm1" %>
    ...
    <form id="form1" runat="server">
        <section class="popup-graybox">
            <div class="ebook-popup-sec" >
                ...
                <h2 data-edit="text">Create Account</h2>
                <div class="auto-style5">
                    <table align="center" class="auto-style2">
                        <tr>
                            <td class="auto-style1">First Name</td>
                            <td>
                                <asp:TextBox ID="FirstName" runat="server"  class="ebookemail-input1"  Width="235px"></asp:TextBox>
                            </td>
                            <td>
                                <asp:RequiredFieldValidator ID="FNValidator" runat="server" ErrorMessage="Enter First Name." ControlToValidate="FirstName" Display="Dynamic" ForeColor="Red" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style1">Last Name</td>
                            <td>
                                <asp:TextBox ID="LastName" runat="server" class="ebookemail-input1"  Width="235px"></asp:TextBox>
                            </td>
                            <td>
                                <asp:RequiredFieldValidator ID="LNValidator" runat="server" ErrorMessage="Enter Last Name." ControlToValidate="LastName" Display="Dynamic" ForeColor="Red" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style1">Username</td>
                            <td>
                                <asp:TextBox ID="Username" runat="server" class="ebookemail-input1"  Width="235px"></asp:TextBox>
                            </td>
                            <td>
                                <asp:RequiredFieldValidator ID="UNValidator" runat="server" ControlToValidate="Username" Display="Dynamic" ErrorMessage="Enter valid username." ForeColor="Red" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style1">Email</td>
                            <td>   
                                <asp:TextBox ID="Email" runat="server" class="ebookemail-input1"  Width="235px"></asp:TextBox>
                            </td>
                            <td>
                                <asp:RequiredFieldValidator ID="EmailValidator" runat="server" ControlToValidate="Email" Display="Dynamic" ErrorMessage="Enter Email." ForeColor="Red">*</asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="EmailRegValidator" runat="server" ControlToValidate="Email" Display="Dynamic" ErrorMessage="Invalid Email" ForeColor="Blue" SetFocusOnError="True" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">*</asp:RegularExpressionValidator>
                        ...
                        <tr>
                            ...
                            <td class="auto-style4">
                                <asp:TextBox ID="Password" runat="server" TextMode="Password" class="ebookemail-input1"  Width="235px"></asp:TextBox>
                            </td>
                            <td>
                                <asp:RequiredFieldValidator ID="PasswordValidator" runat="server" ControlToValidate="Password" Display="Dynamic" ErrorMessage="Enter Password." ForeColor="Red" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style1">Confirm Password</td>
                            <td>
                                <asp:TextBox ID="ConfirmPass" TextMode="Password" runat="server" class="ebookemail-input1"  Width="235px"></asp:TextBox>
                            </td>
                            <td>
                                <asp:RequiredFieldValidator ID="ConfirmPassValidator" runat="server" ControlToValidate="ConfirmPass" Display="Dynamic" ErrorMessage="Enter Password again to confirm password." ForeColor="Red" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                                <asp:CompareValidator ID="ConfrmPassCompare" runat="server" ControlToCompare="Password" ControlToValidate="ConfirmPass" Display="Dynamic" ErrorMessage="Password and Confirm Password must be same." ForeColor="Red">*</asp:CompareValidator>
                            </td>
                        </tr>
                    </table>
                    <asp:Button ID="Button1" runat="server" class="ebook-input-btn" OnClick="RegisterButton_Click" Text="Register" Width="212px" />
                </div>
                <h3><asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="Red"/></h3>
                <h3>Already Registered? <asp:HyperLink ID="HyperLink1" runat="server" NavigateURl="~/Login.aspx">Login</asp:HyperLink></h3>
            </div>
        </section>  
    </form>
</body>
