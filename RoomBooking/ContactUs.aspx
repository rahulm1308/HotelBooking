<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="RoomBooking.ContactUs" %>
								...
								<div class="header_content_inner d-flex flex-row align-items-end justify-content-start">
									...
									<nav class="main_nav">
										<ul class="d-flex flex-row align-items-start justify-content-start">
											...
											<li class="active"><asp:HyperLink runat="server" NavigateUrl="~/ContactUs.aspx">Contact Us</asp:HyperLink></li>
						...
						<div class="col-lg-6">
							<div class="contact_form_container">
								<form  id="form1" runat="server" class="contact_form">
									<div style="margin-bottom: 18px"><asp:TextBox ID="Name" runat="server" TextMode="SingleLine" Placeholder="Your Name" CssClass="contact_input contact_input_name inpt"></asp:TextBox><div class="input_border"></div></div>
									<div class="row">
										<div class="col-lg-6" style="margin-bottom: 18px">
                                            <div><asp:TextBox ID="Email" runat="server" TextMode="Email" Placeholder="Your Email" CssClass="contact_input contact_input_email inpt"></asp:TextBox><div class="input_border" style="bottom:3px"></div></div>
										</div>
										<div class="col-lg-6" style="margin-bottom: 18px">
											<div><asp:TextBox ID="Subject" runat="server" TextMode="SingleLine" Placeholder="Subject" CssClass="contact_input contact_input_subject inpt" ></asp:TextBox><div class="input_border" style="bottom:3px"></div></div>
										</div>
									</div>
									<div><asp:TextBox ID="Message" runat="server" TextMode="MultiLine" Placeholder="Message" CssClass="contact_textarea contact_input inpt" ></asp:TextBox><div class="input_border" style="bottom:3px"></div></div>
